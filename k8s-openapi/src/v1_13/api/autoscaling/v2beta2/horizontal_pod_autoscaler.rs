...
pub struct HorizontalPodAutoscaler {
    ...
    pub spec: Option<crate::v1_13::api::autoscaling::v2beta2::HorizontalPodAutoscalerSpec>,

    /// status is the current information about the autoscaler.
    pub status: Option<crate::v1_13::api::autoscaling::v2beta2::HorizontalPodAutoscalerStatus>,
}
...
impl HorizontalPodAutoscaler {
    ...
    pub fn create_namespaced_horizontal_pod_autoscaler(
        namespace: &str,
        body: &crate::v1_13::api::autoscaling::v2beta2::HorizontalPodAutoscaler,
        ...
        let __url = format!("/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers?", namespace = namespace);
...
impl HorizontalPodAutoscaler {
    ...
    pub fn delete_namespaced_horizontal_pod_autoscaler(
        ...
        let __url = format!("/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}?", name = name, namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(dry_run) = dry_run {
        }
...
impl HorizontalPodAutoscaler {
    ...
    pub fn list_horizontal_pod_autoscaler_for_all_namespaces(
        ...
        let __url = format!("/apis/autoscaling/v2beta2/horizontalpodautoscalers?");
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(continue_) = continue_ {
        }
        if let Some(field_selector) = field_selector {
...
impl HorizontalPodAutoscaler {
    ...
    pub fn patch_namespaced_horizontal_pod_autoscaler_status(
        ...
        let __url = format!("/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}/status?", name = name, namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(dry_run) = dry_run {
        }
        if let Some(pretty) = pretty {
...
// Generated from operation watchAutoscalingV2beta2HorizontalPodAutoscalerListForAllNamespaces
...
impl HorizontalPodAutoscaler {
    ...
    pub fn watch_horizontal_pod_autoscaler_list_for_all_namespaces(
        ...
        let __url = format!("/apis/autoscaling/v2beta2/watch/horizontalpodautoscalers?");
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(continue_) = continue_ {
        }
        if let Some(field_selector) = field_selector {
...
impl HorizontalPodAutoscaler {
    ...
    pub fn watch_namespaced_horizontal_pod_autoscaler(
        ...
        let __url = format!("/apis/autoscaling/v2beta2/watch/namespaces/{namespace}/horizontalpodautoscalers/{name}?", name = name, namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(continue_) = continue_ {
        }
        if let Some(field_selector) = field_selector {
...
// Generated from operation watchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerList
...
impl HorizontalPodAutoscaler {
    ...
    pub fn watch_namespaced_horizontal_pod_autoscaler_list(
        ...
        let __url = format!("/apis/autoscaling/v2beta2/watch/namespaces/{namespace}/horizontalpodautoscalers?", namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(continue_) = continue_ {
        }
        if let Some(field_selector) = field_selector {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_13::api::autoscaling::v2beta2::HorizontalPodAutoscalerSpec> = None;
                let mut value_status: Option<crate::v1_13::api::autoscaling::v2beta2::HorizontalPodAutoscalerStatus> = None;
