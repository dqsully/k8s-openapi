...
pub struct DaemonSet {
    ...
    pub spec: Option<crate::v1_13::api::apps::v1::DaemonSetSpec>,

    /// The current status of this daemon set. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    pub status: Option<crate::v1_13::api::apps::v1::DaemonSetStatus>,
}
...
impl DaemonSet {
    ...
    pub fn list_daemon_set_for_all_namespaces(
        ...
        let __url = format!("/apis/apps/v1/daemonsets?");
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(continue_) = continue_ {
        }
        if let Some(field_selector) = field_selector {
...
// Generated from operation watchAppsV1DaemonSetListForAllNamespaces
...
impl DaemonSet {
    ...
    pub fn watch_daemon_set_list_for_all_namespaces(
        ...
        let __url = format!("/apis/apps/v1/watch/daemonsets?");
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(continue_) = continue_ {
        }
        if let Some(field_selector) = field_selector {
...
impl DaemonSet {
    ...
    pub fn watch_namespaced_daemon_set(
        ...
        let __url = format!("/apis/apps/v1/watch/namespaces/{namespace}/daemonsets/{name}?", name = name, namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(continue_) = continue_ {
        }
        if let Some(field_selector) = field_selector {
...
// Generated from operation watchAppsV1NamespacedDaemonSetList
...
impl DaemonSet {
    ...
    pub fn watch_namespaced_daemon_set_list(
        ...
        let __url = format!("/apis/apps/v1/watch/namespaces/{namespace}/daemonsets?", namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(continue_) = continue_ {
        }
        if let Some(field_selector) = field_selector {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_13::api::apps::v1::DaemonSetSpec> = None;
                let mut value_status: Option<crate::v1_13::api::apps::v1::DaemonSetStatus> = None;
