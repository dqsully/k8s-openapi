...
impl ClusterRoleBinding {
    ...
    pub fn create_cluster_role_binding(
        body: &crate::v1_10::api::rbac::v1beta1::ClusterRoleBinding,
...
pub enum CreateClusterRoleBindingResponse {
    ...
    Created(crate::v1_10::api::rbac::v1beta1::ClusterRoleBinding),
    Accepted(crate::v1_10::api::rbac::v1beta1::ClusterRoleBinding),
...
pub enum DeleteClusterRoleBindingResponse {
    ...
    OkValue(crate::v1_10::api::rbac::v1beta1::ClusterRoleBinding),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteCollectionClusterRoleBindingResponse {
    OkStatus(crate::v1_10::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_10::api::rbac::v1beta1::ClusterRoleBindingList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
