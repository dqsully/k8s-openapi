...
pub struct SelfSubjectRulesReview {
    ...
    pub spec: crate::v1_10::api::authorization::v1beta1::SelfSubjectRulesReviewSpec,

    /// Status is filled in by the server and indicates the set of actions a user can perform.
    pub status: Option<crate::v1_10::api::authorization::v1beta1::SubjectRulesReviewStatus>,
}
...
impl SelfSubjectRulesReview {
    ...
    pub fn create_self_subject_rules_review(
        body: &crate::v1_10::api::authorization::v1beta1::SelfSubjectRulesReview,
...
pub enum CreateSelfSubjectRulesReviewResponse {
    Ok(crate::v1_10::api::authorization::v1beta1::SelfSubjectRulesReview),
    Created(crate::v1_10::api::authorization::v1beta1::SelfSubjectRulesReview),
    Accepted(crate::v1_10::api::authorization::v1beta1::SelfSubjectRulesReview),
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_10::api::authorization::v1beta1::SelfSubjectRulesReviewSpec> = None;
                let mut value_status: Option<crate::v1_10::api::authorization::v1beta1::SubjectRulesReviewStatus> = None;
