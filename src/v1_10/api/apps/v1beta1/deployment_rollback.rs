...
pub struct DeploymentRollback {
    ...
    pub rollback_to: crate::v1_10::api::apps::v1beta1::RollbackConfig,
...
impl DeploymentRollback {
    ...
    pub fn create_namespaced_deployment_rollback(
        name: &str,
        namespace: &str,
        body: &crate::v1_10::api::apps::v1beta1::DeploymentRollback,
...
pub enum CreateNamespacedDeploymentRollbackResponse {
    Ok(crate::v1_10::apimachinery::pkg::apis::meta::v1::Status),
    Created(crate::v1_10::apimachinery::pkg::apis::meta::v1::Status),
    Accepted(crate::v1_10::apimachinery::pkg::apis::meta::v1::Status),
