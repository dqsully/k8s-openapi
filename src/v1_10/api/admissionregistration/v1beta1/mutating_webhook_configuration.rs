...
pub enum CreateMutatingWebhookConfigurationResponse {
    ...
    Created(crate::v1_10::api::admissionregistration::v1beta1::MutatingWebhookConfiguration),
    Accepted(crate::v1_10::api::admissionregistration::v1beta1::MutatingWebhookConfiguration),
...
pub enum DeleteCollectionMutatingWebhookConfigurationResponse {
    ...
    OkValue(crate::v1_10::api::admissionregistration::v1beta1::MutatingWebhookConfigurationList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchMutatingWebhookConfigurationResponse {
    Ok(crate::v1_10::apimachinery::pkg::apis::meta::v1::WatchEvent<MutatingWebhookConfiguration>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
