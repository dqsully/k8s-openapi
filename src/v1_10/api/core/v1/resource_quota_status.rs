...
pub struct ResourceQuotaStatus {
    ...
    pub hard: Option<std::collections::BTreeMap<String, Option<crate::v1_10::apimachinery::pkg::api::resource::Quantity>>>,

    /// Used is the current observed total usage of the resource in the namespace.
    pub used: Option<std::collections::BTreeMap<String, Option<crate::v1_10::apimachinery::pkg::api::resource::Quantity>>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_hard: Option<std::collections::BTreeMap<String, Option<crate::v1_10::apimachinery::pkg::api::resource::Quantity>>> = None;
                let mut value_used: Option<std::collections::BTreeMap<String, Option<crate::v1_10::apimachinery::pkg::api::resource::Quantity>>> = None;
