...
pub struct Endpoints {
    ...
    pub subsets: Option<Vec<crate::v1_10::api::core::v1::EndpointSubset>>,
}
...
impl Endpoints {
    ...
    pub fn create_namespaced_endpoints(
        namespace: &str,
        body: &crate::v1_10::api::core::v1::Endpoints,
...
pub enum CreateNamespacedEndpointsResponse {
    Ok(crate::v1_10::api::core::v1::Endpoints),
    Created(crate::v1_10::api::core::v1::Endpoints),
    Accepted(crate::v1_10::api::core::v1::Endpoints),
...
pub enum DeleteCollectionNamespacedEndpointsResponse {
    ...
    OkValue(crate::v1_10::api::core::v1::EndpointsList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListEndpointsForAllNamespacesResponse {
    Ok(crate::v1_10::api::core::v1::EndpointsList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchEndpointsForAllNamespacesResponse {
    Ok(crate::v1_10::apimachinery::pkg::apis::meta::v1::WatchEvent<Endpoints>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_subsets: Option<Vec<crate::v1_10::api::core::v1::EndpointSubset>> = None;
