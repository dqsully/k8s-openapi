...
pub struct Event {
    ...
    pub event_time: Option<crate::v1_10::apimachinery::pkg::apis::meta::v1::MicroTime>,

    /// The time at which the event was first recorded. (Time of server receipt is in TypeMeta.)
    pub first_timestamp: Option<crate::v1_10::apimachinery::pkg::apis::meta::v1::Time>,

    /// The object that this event is about.
    pub involved_object: crate::v1_10::api::core::v1::ObjectReference,

    /// The time at which the most recent occurrence of this event was recorded.
    pub last_timestamp: Option<crate::v1_10::apimachinery::pkg::apis::meta::v1::Time>,

    /// A human-readable description of the status of this operation.
    pub message: Option<String>,

    /// Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
    pub metadata: crate::v1_10::apimachinery::pkg::apis::meta::v1::ObjectMeta,
    ...
    pub series: Option<crate::v1_10::api::core::v1::EventSeries>,

    /// The component reporting this event. Should be a short machine understandable string.
    pub source: Option<crate::v1_10::api::core::v1::EventSource>,
...
impl Event {
    ...
    pub fn create_namespaced_event(
        namespace: &str,
        body: &crate::v1_10::api::core::v1::Event,
...
pub enum CreateNamespacedEventResponse {
    Ok(crate::v1_10::api::core::v1::Event),
    Created(crate::v1_10::api::core::v1::Event),
    Accepted(crate::v1_10::api::core::v1::Event),
...
pub enum DeleteCollectionNamespacedEventResponse {
    ...
    OkValue(crate::v1_10::api::core::v1::EventList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedEventResponse {
    OkStatus(crate::v1_10::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_10::api::core::v1::Event),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListEventForAllNamespacesResponse {
    Ok(crate::v1_10::api::core::v1::EventList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_first_timestamp: Option<crate::v1_10::apimachinery::pkg::apis::meta::v1::Time> = None;
                let mut value_involved_object: Option<crate::v1_10::api::core::v1::ObjectReference> = None;
                let mut value_last_timestamp: Option<crate::v1_10::apimachinery::pkg::apis::meta::v1::Time> = None;
                ...
                let mut value_series: Option<crate::v1_10::api::core::v1::EventSeries> = None;
                let mut value_source: Option<crate::v1_10::api::core::v1::EventSource> = None;
