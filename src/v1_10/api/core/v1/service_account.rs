...
pub struct ServiceAccount {
    ...
    pub secrets: Option<Vec<crate::v1_10::api::core::v1::ObjectReference>>,
}
...
pub enum DeleteCollectionNamespacedServiceAccountResponse {
    ...
    OkValue(crate::v1_10::api::core::v1::ServiceAccountList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchNamespacedServiceAccountResponse {
    Ok(crate::v1_10::apimachinery::pkg::apis::meta::v1::WatchEvent<ServiceAccount>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_secrets: Option<Vec<crate::v1_10::api::core::v1::ObjectReference>> = None;
