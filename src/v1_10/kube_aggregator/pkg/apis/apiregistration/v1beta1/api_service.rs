...
pub struct APIService {
    ...
    pub spec: Option<crate::v1_10::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIServiceSpec>,

    /// Status contains derived information about an API server
    pub status: Option<crate::v1_10::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIServiceStatus>,
}
...
impl APIService {
    ...
    pub fn create_api_service(
        body: &crate::v1_10::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIService,
...
pub enum CreateAPIServiceResponse {
    Ok(crate::v1_10::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIService),
    Created(crate::v1_10::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIService),
    Accepted(crate::v1_10::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIService),
...
pub enum DeleteAPIServiceResponse {
    ...
    OkValue(crate::v1_10::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIService),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteCollectionAPIServiceResponse {
    OkStatus(crate::v1_10::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_10::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIServiceList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListAPIServiceResponse {
    Ok(crate::v1_10::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIServiceList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_10::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIServiceSpec> = None;
                let mut value_status: Option<crate::v1_10::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIServiceStatus> = None;
