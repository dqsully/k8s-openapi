...
impl RuntimeClass {
    ...
    pub fn create_runtime_class(
        body: &crate::v1_15::api::node::v1beta1::RuntimeClass,
        ...
        let __url = "/apis/node.k8s.io/v1beta1/runtimeclasses?";
...
pub enum CreateRuntimeClassResponse {
    ...
    Created(crate::v1_15::api::node::v1beta1::RuntimeClass),
    Accepted(crate::v1_15::api::node::v1beta1::RuntimeClass),
...
pub enum DeleteCollectionRuntimeClassResponse {
    ...
    OkValue(crate::v1_15::api::node::v1beta1::RuntimeClassList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteRuntimeClassResponse {
    OkStatus(crate::v1_15::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_15::api::node::v1beta1::RuntimeClass),
