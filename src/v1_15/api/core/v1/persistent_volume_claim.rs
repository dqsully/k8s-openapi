...
pub struct PersistentVolumeClaim {
    ...
    pub spec: Option<crate::v1_15::api::core::v1::PersistentVolumeClaimSpec>,

    /// Status represents the current information/status of a persistent volume claim. Read-only. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims
    pub status: Option<crate::v1_15::api::core::v1::PersistentVolumeClaimStatus>,
}
...
impl PersistentVolumeClaim {
    ...
    pub fn create_namespaced_persistent_volume_claim(
        namespace: &str,
        body: &crate::v1_15::api::core::v1::PersistentVolumeClaim,
...
pub enum CreateNamespacedPersistentVolumeClaimResponse {
    Ok(crate::v1_15::api::core::v1::PersistentVolumeClaim),
    Created(crate::v1_15::api::core::v1::PersistentVolumeClaim),
    Accepted(crate::v1_15::api::core::v1::PersistentVolumeClaim),
...
pub enum DeleteCollectionNamespacedPersistentVolumeClaimResponse {
    ...
    OkValue(crate::v1_15::api::core::v1::PersistentVolumeClaimList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedPersistentVolumeClaimResponse {
    OkStatus(crate::v1_15::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_15::api::core::v1::PersistentVolumeClaim),
...
pub enum ListNamespacedPersistentVolumeClaimResponse {
    Ok(crate::v1_15::api::core::v1::PersistentVolumeClaimList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
impl PersistentVolumeClaim {
    ...
    pub fn list_persistent_volume_claim_for_all_namespaces(
        ...
        let __url = "/api/v1/persistentvolumeclaims?";
        let __request = crate::__build_request2(
            crate::http::Method::GET,
            __url.to_owned(),
            |__query_pairs| optional.__serialize(__query_pairs),
...
pub enum WatchNamespacedPersistentVolumeClaimResponse {
    Ok(crate::v1_15::apimachinery::pkg::apis::meta::v1::WatchEvent<PersistentVolumeClaim>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_15::api::core::v1::PersistentVolumeClaimSpec> = None;
                let mut value_status: Option<crate::v1_15::api::core::v1::PersistentVolumeClaimStatus> = None;
