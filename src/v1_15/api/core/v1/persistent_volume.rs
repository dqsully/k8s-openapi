...
pub struct PersistentVolume {
    ...
    pub spec: Option<crate::v1_15::api::core::v1::PersistentVolumeSpec>,

    /// Status represents the current information/status for the persistent volume. Populated by the system. Read-only. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistent-volumes
    pub status: Option<crate::v1_15::api::core::v1::PersistentVolumeStatus>,
}
...
impl PersistentVolume {
    ...
    pub fn create_persistent_volume(
        body: &crate::v1_15::api::core::v1::PersistentVolume,
...
pub enum CreatePersistentVolumeResponse {
    Ok(crate::v1_15::api::core::v1::PersistentVolume),
    Created(crate::v1_15::api::core::v1::PersistentVolume),
    Accepted(crate::v1_15::api::core::v1::PersistentVolume),
...
pub enum DeleteCollectionPersistentVolumeResponse {
    ...
    OkValue(crate::v1_15::api::core::v1::PersistentVolumeList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeletePersistentVolumeResponse {
    OkStatus(crate::v1_15::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_15::api::core::v1::PersistentVolume),
...
pub enum ListPersistentVolumeResponse {
    Ok(crate::v1_15::api::core::v1::PersistentVolumeList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchPersistentVolumeResponse {
    Ok(crate::v1_15::apimachinery::pkg::apis::meta::v1::WatchEvent<PersistentVolume>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_15::api::core::v1::PersistentVolumeSpec> = None;
                let mut value_status: Option<crate::v1_15::api::core::v1::PersistentVolumeStatus> = None;
