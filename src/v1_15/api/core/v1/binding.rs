...
pub struct Binding {
    ...
    pub target: crate::v1_15::api::core::v1::ObjectReference,
}
...
pub enum CreateNamespacedBindingResponse {
    ...
    Created(crate::v1_15::api::core::v1::Binding),
    Accepted(crate::v1_15::api::core::v1::Binding),
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_target: Option<crate::v1_15::api::core::v1::ObjectReference> = None;
