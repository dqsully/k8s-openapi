...
impl Role {
    ...
    pub fn create_namespaced_role(
        namespace: &str,
        body: &crate::v1_15::api::rbac::v1::Role,
...
pub enum CreateNamespacedRoleResponse {
    Ok(crate::v1_15::api::rbac::v1::Role),
    Created(crate::v1_15::api::rbac::v1::Role),
    Accepted(crate::v1_15::api::rbac::v1::Role),
...
pub enum DeleteCollectionNamespacedRoleResponse {
    ...
    OkValue(crate::v1_15::api::rbac::v1::RoleList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedRoleResponse {
    OkStatus(crate::v1_15::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_15::api::rbac::v1::Role),
...
pub enum ListNamespacedRoleResponse {
    Ok(crate::v1_15::api::rbac::v1::RoleList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
