...
pub struct ReplicaSet {
    ...
    pub spec: Option<crate::v1_15::api::extensions::v1beta1::ReplicaSetSpec>,

    /// Status is the most recently observed status of the ReplicaSet. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    pub status: Option<crate::v1_15::api::extensions::v1beta1::ReplicaSetStatus>,
}
...
impl ReplicaSet {
    ...
    pub fn create_namespaced_replica_set(
        namespace: &str,
        body: &crate::v1_15::api::extensions::v1beta1::ReplicaSet,
...
pub enum CreateNamespacedReplicaSetResponse {
    ...
    Created(crate::v1_15::api::extensions::v1beta1::ReplicaSet),
    Accepted(crate::v1_15::api::extensions::v1beta1::ReplicaSet),
...
pub enum DeleteCollectionNamespacedReplicaSetResponse {
    ...
    OkValue(crate::v1_15::api::extensions::v1beta1::ReplicaSetList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedReplicaSetResponse {
    OkStatus(crate::v1_15::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_15::api::extensions::v1beta1::ReplicaSet),
...
pub enum ListNamespacedReplicaSetResponse {
    Ok(crate::v1_15::api::extensions::v1beta1::ReplicaSetList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
impl ReplicaSet {
    ...
    pub fn list_replica_set_for_all_namespaces(
        ...
        let __url = "/apis/extensions/v1beta1/replicasets?";
        let __request = crate::__build_request2(
            crate::http::Method::GET,
            __url.to_owned(),
            |__query_pairs| optional.__serialize(__query_pairs),
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_15::api::extensions::v1beta1::ReplicaSetSpec> = None;
                let mut value_status: Option<crate::v1_15::api::extensions::v1beta1::ReplicaSetStatus> = None;
