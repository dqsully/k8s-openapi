...
pub struct StorageClass {
    ...
    pub allowed_topologies: Option<Vec<crate::v1_15::api::core::v1::TopologySelectorTerm>>,
...
impl StorageClass {
    ...
    pub fn create_storage_class(
        body: &crate::v1_15::api::storage::v1beta1::StorageClass,
        ...
        let __url = "/apis/storage.k8s.io/v1beta1/storageclasses?";
...
pub enum CreateStorageClassResponse {
    Ok(crate::v1_15::api::storage::v1beta1::StorageClass),
    Created(crate::v1_15::api::storage::v1beta1::StorageClass),
    Accepted(crate::v1_15::api::storage::v1beta1::StorageClass),
...
pub enum DeleteCollectionStorageClassResponse {
    ...
    OkValue(crate::v1_15::api::storage::v1beta1::StorageClassList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteStorageClassResponse {
    OkStatus(crate::v1_15::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_15::api::storage::v1beta1::StorageClass),
...
pub enum ListStorageClassResponse {
    Ok(crate::v1_15::api::storage::v1beta1::StorageClassList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchStorageClassResponse {
    Ok(crate::v1_15::apimachinery::pkg::apis::meta::v1::WatchEvent<StorageClass>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_allowed_topologies: Option<Vec<crate::v1_15::api::core::v1::TopologySelectorTerm>> = None;
