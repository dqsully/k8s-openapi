...
pub struct Lease {
    ...
    pub spec: Option<crate::v1_15::api::coordination::v1::LeaseSpec>,
}
...
impl Lease {
    ...
    pub fn create_namespaced_lease(
        namespace: &str,
        body: &crate::v1_15::api::coordination::v1::Lease,
...
pub enum CreateNamespacedLeaseResponse {
    Ok(crate::v1_15::api::coordination::v1::Lease),
    Created(crate::v1_15::api::coordination::v1::Lease),
    Accepted(crate::v1_15::api::coordination::v1::Lease),
...
pub enum DeleteCollectionNamespacedLeaseResponse {
    ...
    OkValue(crate::v1_15::api::coordination::v1::LeaseList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedLeaseResponse {
    OkStatus(crate::v1_15::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_15::api::coordination::v1::Lease),
...
impl Lease {
    ...
    pub fn list_lease_for_all_namespaces(
        ...
        let __url = "/apis/coordination.k8s.io/v1/leases?";
        let __request = crate::__build_request2(
...
pub enum ListLeaseForAllNamespacesResponse {
    Ok(crate::v1_15::api::coordination::v1::LeaseList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_15::api::coordination::v1::LeaseSpec> = None;
