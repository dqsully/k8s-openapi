...
pub struct LimitRangeItem {
    ...
    pub default: Option<std::collections::BTreeMap<String, Option<crate::v1_16::apimachinery::pkg::api::resource::Quantity>>>,

    /// DefaultRequest is the default resource requirement request value by resource name if resource request is omitted.
    pub default_request: Option<std::collections::BTreeMap<String, Option<crate::v1_16::apimachinery::pkg::api::resource::Quantity>>>,

    /// Max usage constraints on this kind by resource name.
    pub max: Option<std::collections::BTreeMap<String, Option<crate::v1_16::apimachinery::pkg::api::resource::Quantity>>>,

    /// MaxLimitRequestRatio if specified, the named resource must have a request and limit that are both non-zero where limit divided by request is less than or equal to the enumerated value; this represents the max burst for the named resource.
    pub max_limit_request_ratio: Option<std::collections::BTreeMap<String, Option<crate::v1_16::apimachinery::pkg::api::resource::Quantity>>>,

    /// Min usage constraints on this kind by resource name.
    pub min: Option<std::collections::BTreeMap<String, Option<crate::v1_16::apimachinery::pkg::api::resource::Quantity>>>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_default: Option<std::collections::BTreeMap<String, Option<crate::v1_16::apimachinery::pkg::api::resource::Quantity>>> = None;
                let mut value_default_request: Option<std::collections::BTreeMap<String, Option<crate::v1_16::apimachinery::pkg::api::resource::Quantity>>> = None;
                let mut value_max: Option<std::collections::BTreeMap<String, Option<crate::v1_16::apimachinery::pkg::api::resource::Quantity>>> = None;
                let mut value_max_limit_request_ratio: Option<std::collections::BTreeMap<String, Option<crate::v1_16::apimachinery::pkg::api::resource::Quantity>>> = None;
                let mut value_min: Option<std::collections::BTreeMap<String, Option<crate::v1_16::apimachinery::pkg::api::resource::Quantity>>> = None;
