...
pub struct ConfigMap {
    ...
    pub binary_data: Option<std::collections::BTreeMap<String, Option<crate::ByteString>>>,
...
impl ConfigMap {
    ...
    pub fn create_namespaced_config_map(
        namespace: &str,
        body: &crate::v1_16::api::core::v1::ConfigMap,
...
pub enum CreateNamespacedConfigMapResponse {
    Ok(crate::v1_16::api::core::v1::ConfigMap),
    Created(crate::v1_16::api::core::v1::ConfigMap),
    Accepted(crate::v1_16::api::core::v1::ConfigMap),
...
pub enum DeleteCollectionNamespacedConfigMapResponse {
    ...
    OkValue(crate::v1_16::api::core::v1::ConfigMapList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedConfigMapResponse {
    OkStatus(crate::v1_16::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_16::api::core::v1::ConfigMap),
...
pub enum ListConfigMapForAllNamespacesResponse {
    Ok(crate::v1_16::api::core::v1::ConfigMapList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchConfigMapForAllNamespacesResponse {
    Ok(crate::v1_16::apimachinery::pkg::apis::meta::v1::WatchEvent<ConfigMap>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_binary_data: Option<std::collections::BTreeMap<String, Option<crate::ByteString>>> = None;
