...
pub enum CreateNamespacedPodPresetResponse {
    Ok(crate::v1_13::api::settings::v1alpha1::PodPreset),
    Created(crate::v1_13::api::settings::v1alpha1::PodPreset),
    Accepted(crate::v1_13::api::settings::v1alpha1::PodPreset),
...
pub enum DeleteCollectionNamespacedPodPresetResponse {
    ...
    OkValue(crate::v1_13::api::settings::v1alpha1::PodPresetList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListNamespacedPodPresetResponse {
    Ok(crate::v1_13::api::settings::v1alpha1::PodPresetList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
