...
pub enum CreateNamespacedHorizontalPodAutoscalerResponse {
    Ok(crate::v1_13::api::autoscaling::v2beta2::HorizontalPodAutoscaler),
    Created(crate::v1_13::api::autoscaling::v2beta2::HorizontalPodAutoscaler),
    Accepted(crate::v1_13::api::autoscaling::v2beta2::HorizontalPodAutoscaler),
...
pub enum DeleteCollectionNamespacedHorizontalPodAutoscalerResponse {
    ...
    OkValue(crate::v1_13::api::autoscaling::v2beta2::HorizontalPodAutoscalerList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedHorizontalPodAutoscalerResponse {
    OkStatus(crate::v1_13::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_13::api::autoscaling::v2beta2::HorizontalPodAutoscaler),
...
impl HorizontalPodAutoscaler {
    ...
    pub fn list_horizontal_pod_autoscaler_for_all_namespaces(
        ...
        let __url = "/apis/autoscaling/v2beta2/horizontalpodautoscalers?";
        let __request = crate::__build_request2(
...
pub enum ListHorizontalPodAutoscalerForAllNamespacesResponse {
    Ok(crate::v1_13::api::autoscaling::v2beta2::HorizontalPodAutoscalerList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchHorizontalPodAutoscalerForAllNamespacesResponse {
    Ok(crate::v1_13::apimachinery::pkg::apis::meta::v1::WatchEvent<HorizontalPodAutoscaler>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
