...
pub enum DeleteCollectionMutatingWebhookConfigurationResponse {
    ...
    OkValue(crate::v1_13::api::admissionregistration::v1beta1::MutatingWebhookConfigurationList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchMutatingWebhookConfigurationResponse {
    Ok(crate::v1_13::apimachinery::pkg::apis::meta::v1::WatchEvent<MutatingWebhookConfiguration>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
