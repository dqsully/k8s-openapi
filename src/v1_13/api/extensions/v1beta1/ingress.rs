...
pub enum CreateNamespacedIngressResponse {
    ...
    Created(crate::v1_13::api::extensions::v1beta1::Ingress),
    Accepted(crate::v1_13::api::extensions::v1beta1::Ingress),
...
pub enum DeleteCollectionNamespacedIngressResponse {
    ...
    OkValue(crate::v1_13::api::extensions::v1beta1::IngressList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedIngressResponse {
    OkStatus(crate::v1_13::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_13::api::extensions::v1beta1::Ingress),
