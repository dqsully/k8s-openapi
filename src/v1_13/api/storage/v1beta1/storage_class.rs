...
impl StorageClass {
    ...
    pub fn create_storage_class(
        body: &crate::v1_13::api::storage::v1beta1::StorageClass,
...
pub enum CreateStorageClassResponse {
    Ok(crate::v1_13::api::storage::v1beta1::StorageClass),
    Created(crate::v1_13::api::storage::v1beta1::StorageClass),
    Accepted(crate::v1_13::api::storage::v1beta1::StorageClass),
...
pub enum DeleteCollectionStorageClassResponse {
    ...
    OkValue(crate::v1_13::api::storage::v1beta1::StorageClassList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteStorageClassResponse {
    OkStatus(crate::v1_13::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_13::api::storage::v1beta1::StorageClass),
...
pub enum ListStorageClassResponse {
    Ok(crate::v1_13::api::storage::v1beta1::StorageClassList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchStorageClassResponse {
    Ok(crate::v1_13::apimachinery::pkg::apis::meta::v1::WatchEvent<StorageClass>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
