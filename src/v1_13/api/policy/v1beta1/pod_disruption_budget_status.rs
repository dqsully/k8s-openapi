...
pub struct PodDisruptionBudgetStatus {
    ...
    pub disrupted_pods: Option<std::collections::BTreeMap<String, Option<crate::v1_13::apimachinery::pkg::apis::meta::v1::Time>>>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_disrupted_pods: Option<std::collections::BTreeMap<String, Option<crate::v1_13::apimachinery::pkg::apis::meta::v1::Time>>> = None;
