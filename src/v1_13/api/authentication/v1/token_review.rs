...
pub struct TokenReview {
    ...
    pub spec: crate::v1_13::api::authentication::v1::TokenReviewSpec,

    /// Status is filled in by the server and indicates whether the request can be authenticated.
    pub status: Option<crate::v1_13::api::authentication::v1::TokenReviewStatus>,
}
...
pub enum CreateTokenReviewResponse {
    Ok(crate::v1_13::api::authentication::v1::TokenReview),
    Created(crate::v1_13::api::authentication::v1::TokenReview),
    Accepted(crate::v1_13::api::authentication::v1::TokenReview),
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_13::api::authentication::v1::TokenReviewSpec> = None;
                let mut value_status: Option<crate::v1_13::api::authentication::v1::TokenReviewStatus> = None;
