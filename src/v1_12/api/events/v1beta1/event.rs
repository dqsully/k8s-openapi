...
pub struct Event {
    ...
    /// Deprecated field assuring backward compatibility with core.v1 Event type
    pub deprecated_first_timestamp: Option<crate::v1_12::apimachinery::pkg::apis::meta::v1::Time>,

    /// Deprecated field assuring backward compatibility with core.v1 Event type
    pub deprecated_last_timestamp: Option<crate::v1_12::apimachinery::pkg::apis::meta::v1::Time>,

    /// Deprecated field assuring backward compatibility with core.v1 Event type
    pub deprecated_source: Option<crate::v1_12::api::core::v1::EventSource>,

    /// Required. Time when this Event was first observed.
    pub event_time: crate::v1_12::apimachinery::pkg::apis::meta::v1::MicroTime,
    ...
    pub regarding: Option<crate::v1_12::api::core::v1::ObjectReference>,

    /// Optional secondary object for more complex actions. E.g. when regarding object triggers a creation or deletion of related object.
    pub related: Option<crate::v1_12::api::core::v1::ObjectReference>,
    ...
    pub series: Option<crate::v1_12::api::events::v1beta1::EventSeries>,
...
impl Event {
    ...
    pub fn create_namespaced_event(
        namespace: &str,
        body: &crate::v1_12::api::events::v1beta1::Event,
        ...
        let __request = crate::__build_request(
            ...
            &[
                ("dryRun", dry_run.as_ref().map(|value| value as _)),
                ("includeUninitialized", include_uninitialized.as_ref().map(|value| value as _)),
...
pub enum CreateNamespacedEventResponse {
    Ok(crate::v1_12::api::events::v1beta1::Event),
    Created(crate::v1_12::api::events::v1beta1::Event),
    Accepted(crate::v1_12::api::events::v1beta1::Event),
...
pub enum DeleteCollectionNamespacedEventResponse {
    ...
    OkValue(crate::v1_12::api::events::v1beta1::EventList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedEventResponse {
    OkStatus(crate::v1_12::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_12::api::events::v1beta1::Event),
...
impl Event {
    ...
    pub fn list_event_for_all_namespaces(
        ...
        let __url = "/apis/events.k8s.io/v1beta1/events?";
        let __request = crate::__build_request2(
...
pub enum ListEventForAllNamespacesResponse {
    Ok(crate::v1_12::api::events::v1beta1::EventList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchEventForAllNamespacesResponse {
    Ok(crate::v1_12::apimachinery::pkg::apis::meta::v1::WatchEvent<Event>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_deprecated_first_timestamp: Option<crate::v1_12::apimachinery::pkg::apis::meta::v1::Time> = None;
                let mut value_deprecated_last_timestamp: Option<crate::v1_12::apimachinery::pkg::apis::meta::v1::Time> = None;
                let mut value_deprecated_source: Option<crate::v1_12::api::core::v1::EventSource> = None;
                let mut value_event_time: Option<crate::v1_12::apimachinery::pkg::apis::meta::v1::MicroTime> = None;
                ...
                let mut value_regarding: Option<crate::v1_12::api::core::v1::ObjectReference> = None;
                let mut value_related: Option<crate::v1_12::api::core::v1::ObjectReference> = None;
                let mut value_reporting_controller: Option<String> = None;
                let mut value_reporting_instance: Option<String> = None;
                let mut value_series: Option<crate::v1_12::api::events::v1beta1::EventSeries> = None;
