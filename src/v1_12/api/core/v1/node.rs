...
pub struct Node {
    ...
    pub spec: Option<crate::v1_12::api::core::v1::NodeSpec>,

    /// Most recently observed status of the node. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    pub status: Option<crate::v1_12::api::core::v1::NodeStatus>,
}
...
impl Node {
    ...
    ///     Optional parameters. Use `Default::default()` to not pass any.
    pub fn create_node(
        body: &crate::v1_12::api::core::v1::Node,
...
pub enum CreateNodeResponse {
    Ok(crate::v1_12::api::core::v1::Node),
    Created(crate::v1_12::api::core::v1::Node),
    Accepted(crate::v1_12::api::core::v1::Node),
...
pub enum DeleteCollectionNodeResponse {
    ...
    OkValue(crate::v1_12::api::core::v1::NodeList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNodeResponse {
    OkStatus(crate::v1_12::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_12::api::core::v1::Node),
...
pub enum ListNodeResponse {
    Ok(crate::v1_12::api::core::v1::NodeList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchNodeResponse {
    Ok(crate::v1_12::apimachinery::pkg::apis::meta::v1::WatchEvent<Node>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_12::api::core::v1::NodeSpec> = None;
                let mut value_status: Option<crate::v1_12::api::core::v1::NodeStatus> = None;
