...
pub struct PodTemplate {
    ...
    pub template: Option<crate::v1_12::api::core::v1::PodTemplateSpec>,
}
...
impl PodTemplate {
    ...
    pub fn create_namespaced_pod_template(
        namespace: &str,
        body: &crate::v1_12::api::core::v1::PodTemplate,
...
pub enum DeleteCollectionNamespacedPodTemplateResponse {
    ...
    OkValue(crate::v1_12::api::core::v1::PodTemplateList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_template: Option<crate::v1_12::api::core::v1::PodTemplateSpec> = None;
