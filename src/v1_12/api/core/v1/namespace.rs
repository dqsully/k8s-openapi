...
pub struct Namespace {
    ...
    pub spec: Option<crate::v1_12::api::core::v1::NamespaceSpec>,

    /// Status describes the current status of a Namespace. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    pub status: Option<crate::v1_12::api::core::v1::NamespaceStatus>,
}
...
impl Namespace {
    ...
    pub fn create_namespace(
        body: &crate::v1_12::api::core::v1::Namespace,
...
pub enum CreateNamespaceResponse {
    Ok(crate::v1_12::api::core::v1::Namespace),
    Created(crate::v1_12::api::core::v1::Namespace),
    Accepted(crate::v1_12::api::core::v1::Namespace),
...
pub enum DeleteNamespaceResponse {
    ...
    OkValue(crate::v1_12::api::core::v1::Namespace),
...
pub enum ListNamespaceResponse {
    Ok(crate::v1_12::api::core::v1::NamespaceList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchNamespaceResponse {
    Ok(crate::v1_12::apimachinery::pkg::apis::meta::v1::WatchEvent<Namespace>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_12::api::core::v1::NamespaceSpec> = None;
                let mut value_status: Option<crate::v1_12::api::core::v1::NamespaceStatus> = None;
