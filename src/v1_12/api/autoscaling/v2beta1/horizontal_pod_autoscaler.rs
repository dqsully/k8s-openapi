...
pub struct HorizontalPodAutoscaler {
    ...
    pub spec: Option<crate::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscalerSpec>,

    /// status is the current information about the autoscaler.
    pub status: Option<crate::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscalerStatus>,
}
...
impl HorizontalPodAutoscaler {
    ...
    pub fn create_namespaced_horizontal_pod_autoscaler(
        namespace: &str,
        body: &crate::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscaler,
...
pub enum CreateNamespacedHorizontalPodAutoscalerResponse {
    ...
    Created(crate::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscaler),
...
pub enum DeleteCollectionNamespacedHorizontalPodAutoscalerResponse {
    ...
    OkValue(crate::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscalerList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedHorizontalPodAutoscalerResponse {
    OkStatus(crate::v1_12::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscaler),
...
impl HorizontalPodAutoscaler {
    ...
    pub fn list_horizontal_pod_autoscaler_for_all_namespaces(
        ...
        let __url = "/apis/autoscaling/v2beta1/horizontalpodautoscalers?";
        let __request = crate::__build_request2(
...
pub enum ListHorizontalPodAutoscalerForAllNamespacesResponse {
    Ok(crate::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscalerList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscalerSpec> = None;
                let mut value_status: Option<crate::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscalerStatus> = None;
