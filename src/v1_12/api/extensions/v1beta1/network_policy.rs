...
pub struct NetworkPolicy {
    ...
    pub spec: Option<crate::v1_12::api::extensions::v1beta1::NetworkPolicySpec>,
}
...
impl NetworkPolicy {
    ...
    pub fn create_namespaced_network_policy(
        namespace: &str,
        body: &crate::v1_12::api::extensions::v1beta1::NetworkPolicy,
...
pub enum CreateNamespacedNetworkPolicyResponse {
    Ok(crate::v1_12::api::extensions::v1beta1::NetworkPolicy),
    Created(crate::v1_12::api::extensions::v1beta1::NetworkPolicy),
    Accepted(crate::v1_12::api::extensions::v1beta1::NetworkPolicy),
...
pub enum DeleteCollectionNamespacedNetworkPolicyResponse {
    ...
    OkValue(crate::v1_12::api::extensions::v1beta1::NetworkPolicyList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedNetworkPolicyResponse {
    OkStatus(crate::v1_12::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_12::api::extensions::v1beta1::NetworkPolicy),
...
pub enum ListNamespacedNetworkPolicyResponse {
    Ok(crate::v1_12::api::extensions::v1beta1::NetworkPolicyList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
impl NetworkPolicy {
    ...
    pub fn list_network_policy_for_all_namespaces(
        ...
        let __url = "/apis/extensions/v1beta1/networkpolicies?";
        let __request = crate::__build_request2(
            crate::http::Method::GET,
            __url.to_owned(),
            |__query_pairs| optional.__serialize(__query_pairs),
...
pub enum WatchNamespacedNetworkPolicyResponse {
    Ok(crate::v1_12::apimachinery::pkg::apis::meta::v1::WatchEvent<NetworkPolicy>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_12::api::extensions::v1beta1::NetworkPolicySpec> = None;
