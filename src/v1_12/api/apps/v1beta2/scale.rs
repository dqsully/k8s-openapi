...
pub struct Scale {
    ...
    pub spec: Option<crate::v1_12::api::apps::v1beta2::ScaleSpec>,

    /// current status of the scale. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status. Read-only.
    pub status: Option<crate::v1_12::api::apps::v1beta2::ScaleStatus>,
}
...
pub enum PatchNamespacedDeploymentScaleResponse {
    Ok(crate::v1_12::api::apps::v1beta2::Scale),
...
impl Scale {
    ...
    pub fn replace_namespaced_deployment_scale(
        name: &str,
        namespace: &str,
        body: &crate::v1_12::api::apps::v1beta2::Scale,
...
pub enum ReplaceNamespacedDeploymentScaleResponse {
    Ok(crate::v1_12::api::apps::v1beta2::Scale),
    Created(crate::v1_12::api::apps::v1beta2::Scale),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_12::api::apps::v1beta2::ScaleSpec> = None;
                let mut value_status: Option<crate::v1_12::api::apps::v1beta2::ScaleStatus> = None;
