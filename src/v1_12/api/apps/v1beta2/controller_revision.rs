...
pub struct ControllerRevision {
    ...
    pub data: Option<crate::v1_12::apimachinery::pkg::runtime::RawExtension>,
...
impl ControllerRevision {
    ...
    pub fn create_namespaced_controller_revision(
        namespace: &str,
        body: &crate::v1_12::api::apps::v1beta2::ControllerRevision,
        ...
        let __url = format!("/apis/apps/v1beta2/namespaces/{namespace}/controllerrevisions?",
...
pub enum CreateNamespacedControllerRevisionResponse {
    Ok(crate::v1_12::api::apps::v1beta2::ControllerRevision),
    Created(crate::v1_12::api::apps::v1beta2::ControllerRevision),
    Accepted(crate::v1_12::api::apps::v1beta2::ControllerRevision),
...
pub enum DeleteCollectionNamespacedControllerRevisionResponse {
    ...
    OkValue(crate::v1_12::api::apps::v1beta2::ControllerRevisionList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
impl ControllerRevision {
    ...
    pub fn delete_namespaced_controller_revision(
        ...
        let __url = format!("/apis/apps/v1beta2/namespaces/{namespace}/controllerrevisions/{name}",
...
pub enum DeleteNamespacedControllerRevisionResponse {
    OkStatus(crate::v1_12::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_12::api::apps::v1beta2::ControllerRevision),
...
impl ControllerRevision {
    ...
    pub fn list_controller_revision_for_all_namespaces(
        ...
        let __url = "/apis/apps/v1beta2/controllerrevisions?";
        let __request = crate::__build_request2(
...
pub enum ListControllerRevisionForAllNamespacesResponse {
    Ok(crate::v1_12::api::apps::v1beta2::ControllerRevisionList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
// Generated from operation watchAppsV1beta2ControllerRevisionForAllNamespaces
...
pub enum WatchControllerRevisionForAllNamespacesResponse {
    Ok(crate::v1_12::apimachinery::pkg::apis::meta::v1::WatchEvent<ControllerRevision>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_data: Option<crate::v1_12::apimachinery::pkg::runtime::RawExtension> = None;
