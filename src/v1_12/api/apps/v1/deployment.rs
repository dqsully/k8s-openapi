...
pub struct Deployment {
    ...
    pub spec: Option<crate::v1_12::api::apps::v1::DeploymentSpec>,

    /// Most recently observed status of the Deployment.
    pub status: Option<crate::v1_12::api::apps::v1::DeploymentStatus>,
}
...
pub enum CreateNamespacedDeploymentResponse {
    ...
    Created(crate::v1_12::api::apps::v1::Deployment),
    Accepted(crate::v1_12::api::apps::v1::Deployment),
...
pub enum DeleteCollectionNamespacedDeploymentResponse {
    ...
    OkValue(crate::v1_12::api::apps::v1::DeploymentList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedDeploymentResponse {
    OkStatus(crate::v1_12::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_12::api::apps::v1::Deployment),
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_12::api::apps::v1::DeploymentSpec> = None;
                let mut value_status: Option<crate::v1_12::api::apps::v1::DeploymentStatus> = None;
