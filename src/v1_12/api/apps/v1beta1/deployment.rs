// Generated from definition io.k8s.api.apps.v1beta1.Deployment
...
pub struct Deployment {
    ...
    pub spec: Option<crate::v1_12::api::apps::v1beta1::DeploymentSpec>,

    /// Most recently observed status of the Deployment.
    pub status: Option<crate::v1_12::api::apps::v1beta1::DeploymentStatus>,
}
...
impl Deployment {
    ...
    pub fn create_namespaced_deployment(
        namespace: &str,
        body: &crate::v1_12::api::apps::v1beta1::Deployment,
        ...
        let __url = format!("/apis/apps/v1beta1/namespaces/{namespace}/deployments?",
...
pub enum CreateNamespacedDeploymentResponse {
    Ok(crate::v1_12::api::apps::v1beta1::Deployment),
    Created(crate::v1_12::api::apps::v1beta1::Deployment),
    Accepted(crate::v1_12::api::apps::v1beta1::Deployment),
...
pub enum DeleteCollectionNamespacedDeploymentResponse {
    ...
    OkValue(crate::v1_12::api::apps::v1beta1::DeploymentList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
impl Deployment {
    ...
    pub fn delete_namespaced_deployment(
        ...
        let __url = format!("/apis/apps/v1beta1/namespaces/{namespace}/deployments/{name}",
...
pub enum DeleteNamespacedDeploymentResponse {
    OkStatus(crate::v1_12::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_12::api::apps::v1beta1::Deployment),
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            http::StatusCode::ACCEPTED => {
                ...
                Ok((DeleteNamespacedDeploymentResponse::Accepted(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
...
impl Deployment {
    ...
    pub fn list_deployment_for_all_namespaces(
        ...
        let __url = "/apis/apps/v1beta1/deployments?";
        let __request = crate::__build_request2(
...
pub enum ListDeploymentForAllNamespacesResponse {
    Ok(crate::v1_12::api::apps::v1beta1::DeploymentList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
impl Deployment {
    ...
    pub fn patch_namespaced_deployment_status(
        ...
        let __url = format!("/apis/apps/v1beta1/namespaces/{namespace}/deployments/{name}/status?",
            name = crate::url::percent_encoding::percent_encode(name.as_bytes(), crate::url::percent_encoding::PATH_SEGMENT_ENCODE_SET),
            namespace = crate::url::percent_encoding::percent_encode(namespace.as_bytes(), crate::url::percent_encoding::PATH_SEGMENT_ENCODE_SET),
        );
        let __request = crate::__build_request2(
...
// Generated from operation watchAppsV1beta1DeploymentForAllNamespaces
...
pub enum WatchDeploymentForAllNamespacesResponse {
    Ok(crate::v1_12::apimachinery::pkg::apis::meta::v1::WatchEvent<Deployment>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_12::api::apps::v1beta1::DeploymentSpec> = None;
                let mut value_status: Option<crate::v1_12::api::apps::v1beta1::DeploymentStatus> = None;
