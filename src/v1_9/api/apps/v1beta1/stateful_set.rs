...
pub struct StatefulSet {
    ...
    pub spec: Option<crate::v1_9::api::apps::v1beta1::StatefulSetSpec>,

    /// Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.
    pub status: Option<crate::v1_9::api::apps::v1beta1::StatefulSetStatus>,
}
...
impl StatefulSet {
    ...
    pub fn create_namespaced_stateful_set(
        namespace: &str,
        body: &crate::v1_9::api::apps::v1beta1::StatefulSet,
...
pub enum CreateNamespacedStatefulSetResponse {
    Ok(crate::v1_9::api::apps::v1beta1::StatefulSet),
    Created(crate::v1_9::api::apps::v1beta1::StatefulSet),
    Accepted(crate::v1_9::api::apps::v1beta1::StatefulSet),
...
pub enum DeleteCollectionNamespacedStatefulSetResponse {
    ...
    OkValue(crate::v1_9::api::apps::v1beta1::StatefulSetList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedStatefulSetResponse {
    OkStatus(crate::v1_9::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_9::api::apps::v1beta1::StatefulSet),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListNamespacedStatefulSetResponse {
    Ok(crate::v1_9::api::apps::v1beta1::StatefulSetList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchNamespacedStatefulSetResponse {
    Ok(crate::v1_9::apimachinery::pkg::apis::meta::v1::WatchEvent<StatefulSet>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_9::api::apps::v1beta1::StatefulSetSpec> = None;
                let mut value_status: Option<crate::v1_9::api::apps::v1beta1::StatefulSetStatus> = None;
