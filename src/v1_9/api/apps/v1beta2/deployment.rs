...
pub struct Deployment {
    ...
    pub spec: Option<crate::v1_9::api::apps::v1beta2::DeploymentSpec>,

    /// Most recently observed status of the Deployment.
    pub status: Option<crate::v1_9::api::apps::v1beta2::DeploymentStatus>,
}
...
pub enum DeleteCollectionNamespacedDeploymentResponse {
    ...
    OkValue(crate::v1_9::api::apps::v1beta2::DeploymentList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_9::api::apps::v1beta2::DeploymentSpec> = None;
                let mut value_status: Option<crate::v1_9::api::apps::v1beta2::DeploymentStatus> = None;
