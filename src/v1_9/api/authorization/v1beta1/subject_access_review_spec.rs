...
pub struct SubjectAccessReviewSpec {
    ...
    pub non_resource_attributes: Option<crate::v1_9::api::authorization::v1beta1::NonResourceAttributes>,

    /// ResourceAuthorizationAttributes describes information for a resource access request
    pub resource_attributes: Option<crate::v1_9::api::authorization::v1beta1::ResourceAttributes>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_non_resource_attributes: Option<crate::v1_9::api::authorization::v1beta1::NonResourceAttributes> = None;
                let mut value_resource_attributes: Option<crate::v1_9::api::authorization::v1beta1::ResourceAttributes> = None;
