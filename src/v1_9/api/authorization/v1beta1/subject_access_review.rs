...
pub struct SubjectAccessReview {
    ...
    pub spec: crate::v1_9::api::authorization::v1beta1::SubjectAccessReviewSpec,
...
impl SubjectAccessReview {
    ...
    pub fn create_subject_access_review(
        body: &crate::v1_9::api::authorization::v1beta1::SubjectAccessReview,
...
pub enum CreateSubjectAccessReviewResponse {
    Ok(crate::v1_9::api::authorization::v1beta1::SubjectAccessReview),
    Created(crate::v1_9::api::authorization::v1beta1::SubjectAccessReview),
    Accepted(crate::v1_9::api::authorization::v1beta1::SubjectAccessReview),
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_9::api::authorization::v1beta1::SubjectAccessReviewSpec> = None;
