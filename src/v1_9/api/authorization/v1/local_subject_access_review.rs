...
impl LocalSubjectAccessReview {
    ...
    pub fn create_namespaced_local_subject_access_review(
        namespace: &str,
        body: &crate::v1_9::api::authorization::v1::LocalSubjectAccessReview,
...
pub enum CreateNamespacedLocalSubjectAccessReviewResponse {
    Ok(crate::v1_9::api::authorization::v1::LocalSubjectAccessReview),
    Created(crate::v1_9::api::authorization::v1::LocalSubjectAccessReview),
    Accepted(crate::v1_9::api::authorization::v1::LocalSubjectAccessReview),
