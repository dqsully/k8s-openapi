...
pub struct ServiceSpec {
    ...
    pub ports: Option<Vec<crate::v1_9::api::core::v1::ServicePort>>,
    ...
    pub session_affinity_config: Option<crate::v1_9::api::core::v1::SessionAffinityConfig>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_ports: Option<Vec<crate::v1_9::api::core::v1::ServicePort>> = None;
                ...
                let mut value_session_affinity_config: Option<crate::v1_9::api::core::v1::SessionAffinityConfig> = None;
