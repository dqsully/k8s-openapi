...
pub struct PersistentVolumeSpec {
    ...
    pub azure_file: Option<crate::v1_9::api::core::v1::AzureFilePersistentVolumeSource>,

    /// A description of the persistent volume's resources and capacity. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#capacity
    pub capacity: Option<std::collections::BTreeMap<String, Option<crate::v1_9::apimachinery::pkg::api::resource::Quantity>>>,

    /// CephFS represents a Ceph FS mount on the host that shares a pod's lifetime
    pub cephfs: Option<crate::v1_9::api::core::v1::CephFSPersistentVolumeSource>,
    ...
    pub claim_ref: Option<crate::v1_9::api::core::v1::ObjectReference>,

    /// CSI represents storage that handled by an external CSI driver
    pub csi: Option<crate::v1_9::api::core::v1::CSIPersistentVolumeSource>,
    ...
    pub iscsi: Option<crate::v1_9::api::core::v1::ISCSIPersistentVolumeSource>,

    /// Local represents directly-attached storage with node affinity
    pub local: Option<crate::v1_9::api::core::v1::LocalVolumeSource>,
    ...
    pub rbd: Option<crate::v1_9::api::core::v1::RBDPersistentVolumeSource>,

    /// ScaleIO represents a ScaleIO persistent volume attached and mounted on Kubernetes nodes.
    pub scale_io: Option<crate::v1_9::api::core::v1::ScaleIOPersistentVolumeSource>,

    /// Name of StorageClass to which this persistent volume belongs. Empty value means that this volume does not belong to any StorageClass.
    pub storage_class_name: Option<String>,

    /// StorageOS represents a StorageOS volume that is attached to the kubelet's host machine and mounted into the pod More info: https://releases.k8s.io/HEAD/examples/volumes/storageos/README.md
    pub storageos: Option<crate::v1_9::api::core::v1::StorageOSPersistentVolumeSource>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_azure_file: Option<crate::v1_9::api::core::v1::AzureFilePersistentVolumeSource> = None;
                let mut value_capacity: Option<std::collections::BTreeMap<String, Option<crate::v1_9::apimachinery::pkg::api::resource::Quantity>>> = None;
                let mut value_cephfs: Option<crate::v1_9::api::core::v1::CephFSPersistentVolumeSource> = None;
                let mut value_cinder: Option<crate::v1_9::api::core::v1::CinderVolumeSource> = None;
                let mut value_claim_ref: Option<crate::v1_9::api::core::v1::ObjectReference> = None;
                let mut value_csi: Option<crate::v1_9::api::core::v1::CSIPersistentVolumeSource> = None;
                ...
                let mut value_iscsi: Option<crate::v1_9::api::core::v1::ISCSIPersistentVolumeSource> = None;
                let mut value_local: Option<crate::v1_9::api::core::v1::LocalVolumeSource> = None;
                ...
                let mut value_rbd: Option<crate::v1_9::api::core::v1::RBDPersistentVolumeSource> = None;
                let mut value_scale_io: Option<crate::v1_9::api::core::v1::ScaleIOPersistentVolumeSource> = None;
                let mut value_storage_class_name: Option<String> = None;
                let mut value_storageos: Option<crate::v1_9::api::core::v1::StorageOSPersistentVolumeSource> = None;
