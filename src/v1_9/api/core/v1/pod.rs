...
pub struct Pod {
    ...
    pub status: Option<crate::v1_9::api::core::v1::PodStatus>,
}
...
impl Pod {
    ...
    pub fn create_namespaced_pod(
        namespace: &str,
        body: &crate::v1_9::api::core::v1::Pod,
...
pub enum CreateNamespacedPodResponse {
    Ok(crate::v1_9::api::core::v1::Pod),
    Created(crate::v1_9::api::core::v1::Pod),
    Accepted(crate::v1_9::api::core::v1::Pod),
...
pub enum DeleteCollectionNamespacedPodResponse {
    ...
    OkValue(crate::v1_9::api::core::v1::PodList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedPodResponse {
    OkStatus(crate::v1_9::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_9::api::core::v1::Pod),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListNamespacedPodResponse {
    Ok(crate::v1_9::api::core::v1::PodList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
impl Pod {
    ...
    pub fn proxy_delete_namespaced_pod(
        ...
        let __url = format!("/api/v1/proxy/namespaces/{namespace}/pods/{name}",
            name = crate::url::percent_encoding::percent_encode(name.as_bytes(), crate::url::percent_encoding::PATH_SEGMENT_ENCODE_SET),
            namespace = crate::url::percent_encoding::percent_encode(namespace.as_bytes(), crate::url::percent_encoding::PATH_SEGMENT_ENCODE_SET),
        );
        let __request = crate::__build_request(
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            _ => {
                ...
                Ok((ProxyDELETENamespacedPodResponse::Other(result), read))
            },
        }
    }
}
...
impl Pod {
    ...
    pub fn proxy_delete_namespaced_pod_with_path(
        ...
        let __url = format!("/api/v1/proxy/namespaces/{namespace}/pods/{name}/{path}",
            name = crate::url::percent_encoding::percent_encode(name.as_bytes(), crate::url::percent_encoding::PATH_SEGMENT_ENCODE_SET),
            namespace = crate::url::percent_encoding::percent_encode(namespace.as_bytes(), crate::url::percent_encoding::PATH_SEGMENT_ENCODE_SET),
            path = crate::url::percent_encoding::percent_encode(path.as_bytes(), crate::url::percent_encoding::PATH_SEGMENT_ENCODE_SET),
        );
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            _ => {
                ...
                Ok((ProxyDELETENamespacedPodWithPathResponse::Other(result), read))
            },
        }
    }
}
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            _ => {
                ...
                Ok((ProxyGETNamespacedPodResponse::Other(result), read))
            },
        }
    }
}
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            _ => {
                ...
                Ok((ProxyGETNamespacedPodWithPathResponse::Other(result), read))
            },
        }
    }
}
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            _ => {
                ...
                Ok((ProxyPATCHNamespacedPodResponse::Other(result), read))
            },
        }
    }
}
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            _ => {
                ...
                Ok((ProxyPATCHNamespacedPodWithPathResponse::Other(result), read))
            },
        }
    }
}
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            _ => {
                ...
                Ok((ProxyPOSTNamespacedPodResponse::Other(result), read))
            },
        }
    }
}
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            _ => {
                ...
                Ok((ProxyPOSTNamespacedPodWithPathResponse::Other(result), read))
            },
        }
    }
}
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            _ => {
                ...
                Ok((ProxyPUTNamespacedPodResponse::Other(result), read))
            },
        }
    }
}
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            _ => {
                ...
                Ok((ProxyPUTNamespacedPodWithPathResponse::Other(result), read))
            },
        }
    }
}
...
pub enum WatchNamespacedPodResponse {
    Ok(crate::v1_9::apimachinery::pkg::apis::meta::v1::WatchEvent<Pod>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_status: Option<crate::v1_9::api::core::v1::PodStatus> = None;
