...
pub struct ResourceQuota {
    ...
    pub spec: Option<crate::v1_9::api::core::v1::ResourceQuotaSpec>,

    /// Status defines the actual enforced quota and its current usage. https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    pub status: Option<crate::v1_9::api::core::v1::ResourceQuotaStatus>,
}
...
impl ResourceQuota {
    ...
    pub fn create_namespaced_resource_quota(
        namespace: &str,
        body: &crate::v1_9::api::core::v1::ResourceQuota,
...
pub enum CreateNamespacedResourceQuotaResponse {
    Ok(crate::v1_9::api::core::v1::ResourceQuota),
    Created(crate::v1_9::api::core::v1::ResourceQuota),
    Accepted(crate::v1_9::api::core::v1::ResourceQuota),
...
pub enum DeleteCollectionNamespacedResourceQuotaResponse {
    ...
    OkValue(crate::v1_9::api::core::v1::ResourceQuotaList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedResourceQuotaResponse {
    OkStatus(crate::v1_9::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_9::api::core::v1::ResourceQuota),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListNamespacedResourceQuotaResponse {
    Ok(crate::v1_9::api::core::v1::ResourceQuotaList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchNamespacedResourceQuotaResponse {
    Ok(crate::v1_9::apimachinery::pkg::apis::meta::v1::WatchEvent<ResourceQuota>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_9::api::core::v1::ResourceQuotaSpec> = None;
                let mut value_status: Option<crate::v1_9::api::core::v1::ResourceQuotaStatus> = None;
