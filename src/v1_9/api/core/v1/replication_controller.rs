...
pub struct ReplicationController {
    ...
    pub spec: Option<crate::v1_9::api::core::v1::ReplicationControllerSpec>,

    /// Status is the most recently observed status of the replication controller. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    pub status: Option<crate::v1_9::api::core::v1::ReplicationControllerStatus>,
}
...
impl ReplicationController {
    ...
    pub fn create_namespaced_replication_controller(
        namespace: &str,
        body: &crate::v1_9::api::core::v1::ReplicationController,
...
pub enum CreateNamespacedReplicationControllerResponse {
    Ok(crate::v1_9::api::core::v1::ReplicationController),
    Created(crate::v1_9::api::core::v1::ReplicationController),
    Accepted(crate::v1_9::api::core::v1::ReplicationController),
...
pub enum DeleteCollectionNamespacedReplicationControllerResponse {
    ...
    OkValue(crate::v1_9::api::core::v1::ReplicationControllerList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedReplicationControllerResponse {
    OkStatus(crate::v1_9::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_9::api::core::v1::ReplicationController),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListNamespacedReplicationControllerResponse {
    Ok(crate::v1_9::api::core::v1::ReplicationControllerList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchNamespacedReplicationControllerResponse {
    Ok(crate::v1_9::apimachinery::pkg::apis::meta::v1::WatchEvent<ReplicationController>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_9::api::core::v1::ReplicationControllerSpec> = None;
                let mut value_status: Option<crate::v1_9::api::core::v1::ReplicationControllerStatus> = None;
