...
impl Role {
    ...
    pub fn create_namespaced_role(
        namespace: &str,
        body: &crate::v1_9::api::rbac::v1alpha1::Role,
...
pub enum CreateNamespacedRoleResponse {
    Ok(crate::v1_9::api::rbac::v1alpha1::Role),
    Created(crate::v1_9::api::rbac::v1alpha1::Role),
    Accepted(crate::v1_9::api::rbac::v1alpha1::Role),
...
pub enum DeleteCollectionNamespacedRoleResponse {
    ...
    OkValue(crate::v1_9::api::rbac::v1alpha1::RoleList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedRoleResponse {
    OkStatus(crate::v1_9::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_9::api::rbac::v1alpha1::Role),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListNamespacedRoleResponse {
    Ok(crate::v1_9::api::rbac::v1alpha1::RoleList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
