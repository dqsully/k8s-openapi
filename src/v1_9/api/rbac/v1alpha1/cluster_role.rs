...
pub struct ClusterRole {
    ...
    pub aggregation_rule: Option<crate::v1_9::api::rbac::v1alpha1::AggregationRule>,

    /// Standard object's metadata.
    pub metadata: Option<crate::v1_9::apimachinery::pkg::apis::meta::v1::ObjectMeta>,

    /// Rules holds all the PolicyRules for this ClusterRole
    pub rules: Vec<crate::v1_9::api::rbac::v1alpha1::PolicyRule>,
}
...
impl ClusterRole {
    ...
    pub fn create_cluster_role(
        body: &crate::v1_9::api::rbac::v1alpha1::ClusterRole,
...
pub enum CreateClusterRoleResponse {
    Ok(crate::v1_9::api::rbac::v1alpha1::ClusterRole),
    Created(crate::v1_9::api::rbac::v1alpha1::ClusterRole),
    Accepted(crate::v1_9::api::rbac::v1alpha1::ClusterRole),
...
pub enum DeleteClusterRoleResponse {
    ...
    OkValue(crate::v1_9::api::rbac::v1alpha1::ClusterRole),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteCollectionClusterRoleResponse {
    OkStatus(crate::v1_9::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_9::api::rbac::v1alpha1::ClusterRoleList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListClusterRoleResponse {
    Ok(crate::v1_9::api::rbac::v1alpha1::ClusterRoleList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_aggregation_rule: Option<crate::v1_9::api::rbac::v1alpha1::AggregationRule> = None;
                let mut value_metadata: Option<crate::v1_9::apimachinery::pkg::apis::meta::v1::ObjectMeta> = None;
                let mut value_rules: Option<Vec<crate::v1_9::api::rbac::v1alpha1::PolicyRule>> = None;
