...
pub struct MutatingWebhookConfiguration {
    ...
    pub webhooks: Option<Vec<crate::v1_9::api::admissionregistration::v1beta1::Webhook>>,
}
...
impl MutatingWebhookConfiguration {
    ...
    pub fn create_mutating_webhook_configuration(
        body: &crate::v1_9::api::admissionregistration::v1beta1::MutatingWebhookConfiguration,
...
pub enum CreateMutatingWebhookConfigurationResponse {
    Ok(crate::v1_9::api::admissionregistration::v1beta1::MutatingWebhookConfiguration),
    Created(crate::v1_9::api::admissionregistration::v1beta1::MutatingWebhookConfiguration),
    Accepted(crate::v1_9::api::admissionregistration::v1beta1::MutatingWebhookConfiguration),
...
pub enum DeleteCollectionMutatingWebhookConfigurationResponse {
    ...
    OkValue(crate::v1_9::api::admissionregistration::v1beta1::MutatingWebhookConfigurationList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteMutatingWebhookConfigurationResponse {
    OkStatus(crate::v1_9::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_9::api::admissionregistration::v1beta1::MutatingWebhookConfiguration),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListMutatingWebhookConfigurationResponse {
    Ok(crate::v1_9::api::admissionregistration::v1beta1::MutatingWebhookConfigurationList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchMutatingWebhookConfigurationResponse {
    Ok(crate::v1_9::apimachinery::pkg::apis::meta::v1::WatchEvent<MutatingWebhookConfiguration>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_webhooks: Option<Vec<crate::v1_9::api::admissionregistration::v1beta1::Webhook>> = None;
