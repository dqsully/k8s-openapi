...
pub enum DeleteCollectionInitializerConfigurationResponse {
    ...
    OkValue(crate::v1_9::api::admissionregistration::v1alpha1::InitializerConfigurationList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchInitializerConfigurationResponse {
    Ok(crate::v1_9::apimachinery::pkg::apis::meta::v1::WatchEvent<InitializerConfiguration>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
