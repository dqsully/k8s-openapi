...
impl PriorityClass {
    ...
    pub fn create_priority_class(
        body: &crate::v1_9::api::scheduling::v1alpha1::PriorityClass,
...
pub enum CreatePriorityClassResponse {
    Ok(crate::v1_9::api::scheduling::v1alpha1::PriorityClass),
    Created(crate::v1_9::api::scheduling::v1alpha1::PriorityClass),
    Accepted(crate::v1_9::api::scheduling::v1alpha1::PriorityClass),
...
pub enum DeleteCollectionPriorityClassResponse {
    ...
    OkValue(crate::v1_9::api::scheduling::v1alpha1::PriorityClassList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeletePriorityClassResponse {
    OkStatus(crate::v1_9::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_9::api::scheduling::v1alpha1::PriorityClass),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListPriorityClassResponse {
    Ok(crate::v1_9::api::scheduling::v1alpha1::PriorityClassList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchPriorityClassResponse {
    Ok(crate::v1_9::apimachinery::pkg::apis::meta::v1::WatchEvent<PriorityClass>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
