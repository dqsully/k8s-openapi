...
pub enum GetAPIVersionsResponse {
    Ok(crate::v1_9::apimachinery::pkg::apis::meta::v1::APIGroupList),
...
pub enum GetAdmissionregistrationAPIGroupResponse {
    Ok(crate::v1_9::apimachinery::pkg::apis::meta::v1::APIGroup),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum GetAdmissionregistrationV1alpha1APIResourcesResponse {
    Ok(crate::v1_9::apimachinery::pkg::apis::meta::v1::APIResourceList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum GetCodeVersionResponse {
    Ok(crate::v1_9::apimachinery::pkg::version::Info),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum GetCoreAPIVersionsResponse {
    Ok(crate::v1_9::apimachinery::pkg::apis::meta::v1::APIVersions),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
