...
pub struct JSONSchemaProps {
    ...
    pub definitions: Option<std::collections::BTreeMap<String, Option<crate::v1_8::apiextensions_apiserver::pkg::apis::apiextensions::v1beta1::JSONSchemaProps>>>,

    pub dependencies: Option<std::collections::BTreeMap<String, Option<crate::v1_8::apiextensions_apiserver::pkg::apis::apiextensions::v1beta1::JSONSchemaPropsOrStringArray>>>,
    ...
    pub pattern_properties: Option<std::collections::BTreeMap<String, Option<crate::v1_8::apiextensions_apiserver::pkg::apis::apiextensions::v1beta1::JSONSchemaProps>>>,

    pub properties: Option<std::collections::BTreeMap<String, Option<crate::v1_8::apiextensions_apiserver::pkg::apis::apiextensions::v1beta1::JSONSchemaProps>>>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_definitions: Option<std::collections::BTreeMap<String, Option<crate::v1_8::apiextensions_apiserver::pkg::apis::apiextensions::v1beta1::JSONSchemaProps>>> = None;
                let mut value_dependencies: Option<std::collections::BTreeMap<String, Option<crate::v1_8::apiextensions_apiserver::pkg::apis::apiextensions::v1beta1::JSONSchemaPropsOrStringArray>>> = None;
                ...
                let mut value_pattern_properties: Option<std::collections::BTreeMap<String, Option<crate::v1_8::apiextensions_apiserver::pkg::apis::apiextensions::v1beta1::JSONSchemaProps>>> = None;
                let mut value_properties: Option<std::collections::BTreeMap<String, Option<crate::v1_8::apiextensions_apiserver::pkg::apis::apiextensions::v1beta1::JSONSchemaProps>>> = None;
