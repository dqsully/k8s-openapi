...
pub struct Deployment {
    ...
    pub spec: Option<crate::v1_8::api::apps::v1beta1::DeploymentSpec>,

    /// Most recently observed status of the Deployment.
    pub status: Option<crate::v1_8::api::apps::v1beta1::DeploymentStatus>,
}
...
impl Deployment {
    ...
    pub fn create_namespaced_deployment(
        namespace: &str,
        body: &crate::v1_8::api::apps::v1beta1::Deployment,
...
pub enum CreateNamespacedDeploymentResponse {
    Ok(crate::v1_8::api::apps::v1beta1::Deployment),
...
pub enum DeleteCollectionNamespacedDeploymentResponse {
    ...
    OkValue(crate::v1_8::api::apps::v1beta1::DeploymentList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedDeploymentResponse {
    OkStatus(crate::v1_8::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_8::api::apps::v1beta1::Deployment),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListDeploymentForAllNamespacesResponse {
    Ok(crate::v1_8::api::apps::v1beta1::DeploymentList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_8::api::apps::v1beta1::DeploymentSpec> = None;
                let mut value_status: Option<crate::v1_8::api::apps::v1beta1::DeploymentStatus> = None;
