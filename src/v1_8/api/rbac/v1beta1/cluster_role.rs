...
pub struct ClusterRole {
    ...
    pub rules: Vec<crate::v1_8::api::rbac::v1beta1::PolicyRule>,
}
...
impl ClusterRole {
    ...
    pub fn create_cluster_role(
        body: &crate::v1_8::api::rbac::v1beta1::ClusterRole,
...
pub enum CreateClusterRoleResponse {
    Ok(crate::v1_8::api::rbac::v1beta1::ClusterRole),
...
pub enum DeleteClusterRoleResponse {
    ...
    OkValue(crate::v1_8::api::rbac::v1beta1::ClusterRole),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteCollectionClusterRoleResponse {
    OkStatus(crate::v1_8::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_8::api::rbac::v1beta1::ClusterRoleList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_rules: Option<Vec<crate::v1_8::api::rbac::v1beta1::PolicyRule>> = None;
