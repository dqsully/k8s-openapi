...
pub struct ComponentStatus {
    ...
    pub conditions: Option<Vec<crate::v1_8::api::core::v1::ComponentCondition>>,
...
pub enum WatchComponentStatusResponse {
    Ok(crate::v1_8::apimachinery::pkg::apis::meta::v1::WatchEvent<ComponentStatus>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_conditions: Option<Vec<crate::v1_8::api::core::v1::ComponentCondition>> = None;
