...
pub struct PodSecurityPolicy {
    ...
    pub spec: Option<crate::v1_8::api::extensions::v1beta1::PodSecurityPolicySpec>,
}
...
pub enum DeleteCollectionPodSecurityPolicyResponse {
    ...
    OkValue(crate::v1_8::api::extensions::v1beta1::PodSecurityPolicyList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_8::api::extensions::v1beta1::PodSecurityPolicySpec> = None;
