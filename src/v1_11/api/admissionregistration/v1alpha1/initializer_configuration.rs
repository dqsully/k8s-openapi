...
pub struct InitializerConfiguration {
    ...
    pub initializers: Option<Vec<crate::v1_11::api::admissionregistration::v1alpha1::Initializer>>,
...
impl InitializerConfiguration {
    ...
    pub fn create_initializer_configuration(
        ...
        let __url = "/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations?";
...
pub enum CreateInitializerConfigurationResponse {
    ...
    Created(crate::v1_11::api::admissionregistration::v1alpha1::InitializerConfiguration),
    Accepted(crate::v1_11::api::admissionregistration::v1alpha1::InitializerConfiguration),
...
pub enum DeleteCollectionInitializerConfigurationResponse {
    ...
    OkValue(crate::v1_11::api::admissionregistration::v1alpha1::InitializerConfigurationList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteInitializerConfigurationResponse {
    OkStatus(crate::v1_11::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_11::api::admissionregistration::v1alpha1::InitializerConfiguration),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_initializers: Option<Vec<crate::v1_11::api::admissionregistration::v1alpha1::Initializer>> = None;
