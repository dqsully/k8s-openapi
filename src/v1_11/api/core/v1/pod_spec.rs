...
pub struct PodSpec {
    ...
    pub affinity: Option<crate::v1_11::api::core::v1::Affinity>,

    /// AutomountServiceAccountToken indicates whether a service account token should be automatically mounted.
    pub automount_service_account_token: Option<bool>,

    /// List of containers belonging to the pod. Containers cannot currently be added or removed. There must be at least one container in a Pod. Cannot be updated.
    pub containers: Vec<crate::v1_11::api::core::v1::Container>,

    /// Specifies the DNS parameters of a pod. Parameters specified here will be merged to the generated DNS configuration based on DNSPolicy.
    pub dns_config: Option<crate::v1_11::api::core::v1::PodDNSConfig>,

    /// Set DNS policy for the pod. Defaults to "ClusterFirst". Valid values are 'ClusterFirstWithHostNet', 'ClusterFirst', 'Default' or 'None'. DNS parameters given in DNSConfig will be merged with the policy selected with DNSPolicy. To have DNS options set along with hostNetwork, you have to specify DNS policy explicitly to 'ClusterFirstWithHostNet'.
    pub dns_policy: Option<String>,

    /// HostAliases is an optional list of hosts and IPs that will be injected into the pod's hosts file if specified. This is only valid for non-hostNetwork pods.
    pub host_aliases: Option<Vec<crate::v1_11::api::core::v1::HostAlias>>,
    ...
    pub image_pull_secrets: Option<Vec<crate::v1_11::api::core::v1::LocalObjectReference>>,
    ...
    pub init_containers: Option<Vec<crate::v1_11::api::core::v1::Container>>,
    ...
    pub readiness_gates: Option<Vec<crate::v1_11::api::core::v1::PodReadinessGate>>,
    ...
    pub security_context: Option<crate::v1_11::api::core::v1::PodSecurityContext>,
    ...
    pub tolerations: Option<Vec<crate::v1_11::api::core::v1::Toleration>>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_affinity: Option<crate::v1_11::api::core::v1::Affinity> = None;
                let mut value_automount_service_account_token: Option<bool> = None;
                let mut value_containers: Option<Vec<crate::v1_11::api::core::v1::Container>> = None;
                let mut value_dns_config: Option<crate::v1_11::api::core::v1::PodDNSConfig> = None;
                let mut value_dns_policy: Option<String> = None;
                let mut value_host_aliases: Option<Vec<crate::v1_11::api::core::v1::HostAlias>> = None;
                ...
                let mut value_image_pull_secrets: Option<Vec<crate::v1_11::api::core::v1::LocalObjectReference>> = None;
                let mut value_init_containers: Option<Vec<crate::v1_11::api::core::v1::Container>> = None;
                ...
                let mut value_readiness_gates: Option<Vec<crate::v1_11::api::core::v1::PodReadinessGate>> = None;
                let mut value_restart_policy: Option<String> = None;
                let mut value_scheduler_name: Option<String> = None;
                let mut value_security_context: Option<crate::v1_11::api::core::v1::PodSecurityContext> = None;
                ...
                let mut value_tolerations: Option<Vec<crate::v1_11::api::core::v1::Toleration>> = None;
