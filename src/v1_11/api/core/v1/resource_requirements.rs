...
pub struct ResourceRequirements {
    ...
    pub limits: Option<std::collections::BTreeMap<String, Option<crate::v1_11::apimachinery::pkg::api::resource::Quantity>>>,

    /// Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/
    pub requests: Option<std::collections::BTreeMap<String, Option<crate::v1_11::apimachinery::pkg::api::resource::Quantity>>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_limits: Option<std::collections::BTreeMap<String, Option<crate::v1_11::apimachinery::pkg::api::resource::Quantity>>> = None;
                let mut value_requests: Option<std::collections::BTreeMap<String, Option<crate::v1_11::apimachinery::pkg::api::resource::Quantity>>> = None;
