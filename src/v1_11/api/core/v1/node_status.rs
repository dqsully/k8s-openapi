...
pub struct NodeStatus {
    ...
    pub addresses: Option<Vec<crate::v1_11::api::core::v1::NodeAddress>>,

    /// Allocatable represents the resources of a node that are available for scheduling. Defaults to Capacity.
    pub allocatable: Option<std::collections::BTreeMap<String, Option<crate::v1_11::apimachinery::pkg::api::resource::Quantity>>>,
    ...
    pub conditions: Option<Vec<crate::v1_11::api::core::v1::NodeCondition>>,

    /// Status of the config assigned to the node via the dynamic Kubelet config feature.
    pub config: Option<crate::v1_11::api::core::v1::NodeConfigStatus>,

    /// Endpoints of daemons running on the Node.
    pub daemon_endpoints: Option<crate::v1_11::api::core::v1::NodeDaemonEndpoints>,

    /// List of container images on this node
    pub images: Option<Vec<crate::v1_11::api::core::v1::ContainerImage>>,

    /// Set of ids/uuids to uniquely identify the node. More info: https://kubernetes.io/docs/concepts/nodes/node/#info
    pub node_info: Option<crate::v1_11::api::core::v1::NodeSystemInfo>,

    /// NodePhase is the recently observed lifecycle phase of the node. More info: https://kubernetes.io/docs/concepts/nodes/node/#phase The field is never populated, and now is deprecated.
    pub phase: Option<String>,

    /// List of volumes that are attached to the node.
    pub volumes_attached: Option<Vec<crate::v1_11::api::core::v1::AttachedVolume>>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_addresses: Option<Vec<crate::v1_11::api::core::v1::NodeAddress>> = None;
                let mut value_allocatable: Option<std::collections::BTreeMap<String, Option<crate::v1_11::apimachinery::pkg::api::resource::Quantity>>> = None;
                ...
                let mut value_conditions: Option<Vec<crate::v1_11::api::core::v1::NodeCondition>> = None;
                let mut value_config: Option<crate::v1_11::api::core::v1::NodeConfigStatus> = None;
                let mut value_daemon_endpoints: Option<crate::v1_11::api::core::v1::NodeDaemonEndpoints> = None;
                let mut value_images: Option<Vec<crate::v1_11::api::core::v1::ContainerImage>> = None;
                let mut value_node_info: Option<crate::v1_11::api::core::v1::NodeSystemInfo> = None;
                let mut value_phase: Option<String> = None;
                let mut value_volumes_attached: Option<Vec<crate::v1_11::api::core::v1::AttachedVolume>> = None;
