...
pub struct DeploymentRollback {
    ...
    pub rollback_to: crate::v1_11::api::apps::v1beta1::RollbackConfig,
...
pub enum CreateNamespacedDeploymentRollbackResponse {
    Ok(crate::v1_11::apimachinery::pkg::apis::meta::v1::Status),
    Created(crate::v1_11::apimachinery::pkg::apis::meta::v1::Status),
    Accepted(crate::v1_11::apimachinery::pkg::apis::meta::v1::Status),
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_rollback_to: Option<crate::v1_11::api::apps::v1beta1::RollbackConfig> = None;
