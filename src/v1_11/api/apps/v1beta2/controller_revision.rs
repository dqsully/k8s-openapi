...
pub struct ControllerRevision {
    ...
    pub data: Option<crate::v1_11::apimachinery::pkg::runtime::RawExtension>,
...
impl ControllerRevision {
    ...
    pub fn create_namespaced_controller_revision(
        namespace: &str,
        body: &crate::v1_11::api::apps::v1beta2::ControllerRevision,
...
pub enum CreateNamespacedControllerRevisionResponse {
    Ok(crate::v1_11::api::apps::v1beta2::ControllerRevision),
    Created(crate::v1_11::api::apps::v1beta2::ControllerRevision),
    Accepted(crate::v1_11::api::apps::v1beta2::ControllerRevision),
...
pub enum DeleteCollectionNamespacedControllerRevisionResponse {
    ...
    OkValue(crate::v1_11::api::apps::v1beta2::ControllerRevisionList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedControllerRevisionResponse {
    OkStatus(crate::v1_11::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_11::api::apps::v1beta2::ControllerRevision),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListControllerRevisionForAllNamespacesResponse {
    Ok(crate::v1_11::api::apps::v1beta2::ControllerRevisionList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchControllerRevisionForAllNamespacesResponse {
    Ok(crate::v1_11::apimachinery::pkg::apis::meta::v1::WatchEvent<ControllerRevision>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_data: Option<crate::v1_11::apimachinery::pkg::runtime::RawExtension> = None;
