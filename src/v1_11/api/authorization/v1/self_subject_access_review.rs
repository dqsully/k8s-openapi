...
pub struct SelfSubjectAccessReview {
    ...
    pub spec: crate::v1_11::api::authorization::v1::SelfSubjectAccessReviewSpec,

    /// Status is filled in by the server and indicates whether the request is allowed or not
    pub status: Option<crate::v1_11::api::authorization::v1::SubjectAccessReviewStatus>,
}
...
impl SelfSubjectAccessReview {
    ...
    pub fn create_self_subject_access_review(
        body: &crate::v1_11::api::authorization::v1::SelfSubjectAccessReview,
...
pub enum CreateSelfSubjectAccessReviewResponse {
    Ok(crate::v1_11::api::authorization::v1::SelfSubjectAccessReview),
    Created(crate::v1_11::api::authorization::v1::SelfSubjectAccessReview),
    Accepted(crate::v1_11::api::authorization::v1::SelfSubjectAccessReview),
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_11::api::authorization::v1::SelfSubjectAccessReviewSpec> = None;
                let mut value_status: Option<crate::v1_11::api::authorization::v1::SubjectAccessReviewStatus> = None;
