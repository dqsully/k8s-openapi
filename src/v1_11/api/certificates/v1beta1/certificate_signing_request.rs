...
pub struct CertificateSigningRequest {
    ...
    pub spec: Option<crate::v1_11::api::certificates::v1beta1::CertificateSigningRequestSpec>,

    /// Derived information about the request.
    pub status: Option<crate::v1_11::api::certificates::v1beta1::CertificateSigningRequestStatus>,
}
...
impl CertificateSigningRequest {
    ...
    pub fn create_certificate_signing_request(
        body: &crate::v1_11::api::certificates::v1beta1::CertificateSigningRequest,
...
pub enum CreateCertificateSigningRequestResponse {
    Ok(crate::v1_11::api::certificates::v1beta1::CertificateSigningRequest),
    Created(crate::v1_11::api::certificates::v1beta1::CertificateSigningRequest),
    Accepted(crate::v1_11::api::certificates::v1beta1::CertificateSigningRequest),
...
pub enum DeleteCertificateSigningRequestResponse {
    ...
    OkValue(crate::v1_11::api::certificates::v1beta1::CertificateSigningRequest),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteCollectionCertificateSigningRequestResponse {
    OkStatus(crate::v1_11::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_11::api::certificates::v1beta1::CertificateSigningRequestList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListCertificateSigningRequestResponse {
    Ok(crate::v1_11::api::certificates::v1beta1::CertificateSigningRequestList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchCertificateSigningRequestResponse {
    Ok(crate::v1_11::apimachinery::pkg::apis::meta::v1::WatchEvent<CertificateSigningRequest>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_11::api::certificates::v1beta1::CertificateSigningRequestSpec> = None;
                let mut value_status: Option<crate::v1_11::api::certificates::v1beta1::CertificateSigningRequestStatus> = None;
