...
pub struct RuntimeClass {
    ...
    pub spec: crate::v1_14::api::node::v1alpha1::RuntimeClassSpec,
}
...
impl RuntimeClass {
    ...
    pub fn create_runtime_class(
        body: &crate::v1_14::api::node::v1alpha1::RuntimeClass,
        ...
        let __url = "/apis/node.k8s.io/v1alpha1/runtimeclasses?";
...
pub enum CreateRuntimeClassResponse {
    Ok(crate::v1_14::api::node::v1alpha1::RuntimeClass),
    Created(crate::v1_14::api::node::v1alpha1::RuntimeClass),
    Accepted(crate::v1_14::api::node::v1alpha1::RuntimeClass),
...
pub enum DeleteCollectionRuntimeClassResponse {
    ...
    OkValue(crate::v1_14::api::node::v1alpha1::RuntimeClassList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteRuntimeClassResponse {
    OkStatus(crate::v1_14::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_14::api::node::v1alpha1::RuntimeClass),
...
pub enum ListRuntimeClassResponse {
    Ok(crate::v1_14::api::node::v1alpha1::RuntimeClassList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_14::api::node::v1alpha1::RuntimeClassSpec> = None;
