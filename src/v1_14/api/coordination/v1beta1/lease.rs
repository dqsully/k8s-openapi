...
pub struct Lease {
    ...
    pub spec: Option<crate::v1_14::api::coordination::v1beta1::LeaseSpec>,
}
...
impl Lease {
    ...
    pub fn create_namespaced_lease(
        namespace: &str,
        body: &crate::v1_14::api::coordination::v1beta1::Lease,
...
pub enum CreateNamespacedLeaseResponse {
    Ok(crate::v1_14::api::coordination::v1beta1::Lease),
    Created(crate::v1_14::api::coordination::v1beta1::Lease),
    Accepted(crate::v1_14::api::coordination::v1beta1::Lease),
...
pub enum DeleteCollectionNamespacedLeaseResponse {
    ...
    OkValue(crate::v1_14::api::coordination::v1beta1::LeaseList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedLeaseResponse {
    OkStatus(crate::v1_14::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_14::api::coordination::v1beta1::Lease),
...
pub enum ListLeaseForAllNamespacesResponse {
    Ok(crate::v1_14::api::coordination::v1beta1::LeaseList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_14::api::coordination::v1beta1::LeaseSpec> = None;
