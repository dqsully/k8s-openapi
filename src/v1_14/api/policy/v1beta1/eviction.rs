...
pub struct Eviction {
    ...
    pub delete_options: Option<crate::v1_14::apimachinery::pkg::apis::meta::v1::DeleteOptions>,
...
impl Eviction {
    ...
    pub fn create_namespaced_pod_eviction(
        name: &str,
        namespace: &str,
        body: &crate::v1_14::api::policy::v1beta1::Eviction,
...
pub enum CreateNamespacedPodEvictionResponse {
    Ok(crate::v1_14::api::policy::v1beta1::Eviction),
    Created(crate::v1_14::api::policy::v1beta1::Eviction),
    Accepted(crate::v1_14::api::policy::v1beta1::Eviction),
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_delete_options: Option<crate::v1_14::apimachinery::pkg::apis::meta::v1::DeleteOptions> = None;
