...
pub struct PodDisruptionBudget {
    ...
    pub spec: Option<crate::v1_14::api::policy::v1beta1::PodDisruptionBudgetSpec>,

    /// Most recently observed status of the PodDisruptionBudget.
    pub status: Option<crate::v1_14::api::policy::v1beta1::PodDisruptionBudgetStatus>,
}
...
impl PodDisruptionBudget {
    ...
    pub fn create_namespaced_pod_disruption_budget(
        namespace: &str,
        body: &crate::v1_14::api::policy::v1beta1::PodDisruptionBudget,
...
pub enum DeleteCollectionNamespacedPodDisruptionBudgetResponse {
    ...
    OkValue(crate::v1_14::api::policy::v1beta1::PodDisruptionBudgetList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_14::api::policy::v1beta1::PodDisruptionBudgetSpec> = None;
                let mut value_status: Option<crate::v1_14::api::policy::v1beta1::PodDisruptionBudgetStatus> = None;
