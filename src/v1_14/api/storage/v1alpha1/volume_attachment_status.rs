...
pub struct VolumeAttachmentStatus {
    ...
    pub attach_error: Option<crate::v1_14::api::storage::v1alpha1::VolumeError>,
    ...
    pub detach_error: Option<crate::v1_14::api::storage::v1alpha1::VolumeError>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_attach_error: Option<crate::v1_14::api::storage::v1alpha1::VolumeError> = None;
                ...
                let mut value_detach_error: Option<crate::v1_14::api::storage::v1alpha1::VolumeError> = None;
