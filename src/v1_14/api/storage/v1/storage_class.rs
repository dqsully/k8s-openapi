...
impl StorageClass {
    ...
    pub fn create_storage_class(
        body: &crate::v1_14::api::storage::v1::StorageClass,
        ...
        let __url = "/apis/storage.k8s.io/v1/storageclasses?";
...
pub enum CreateStorageClassResponse {
    Ok(crate::v1_14::api::storage::v1::StorageClass),
    Created(crate::v1_14::api::storage::v1::StorageClass),
    Accepted(crate::v1_14::api::storage::v1::StorageClass),
...
pub enum DeleteCollectionStorageClassResponse {
    ...
    OkValue(crate::v1_14::api::storage::v1::StorageClassList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteStorageClassResponse {
    OkStatus(crate::v1_14::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_14::api::storage::v1::StorageClass),
...
pub enum ListStorageClassResponse {
    Ok(crate::v1_14::api::storage::v1::StorageClassList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
