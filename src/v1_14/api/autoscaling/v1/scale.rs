...
pub struct Scale {
    ...
    pub spec: Option<crate::v1_14::api::autoscaling::v1::ScaleSpec>,

    /// current status of the scale. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status. Read-only.
    pub status: Option<crate::v1_14::api::autoscaling::v1::ScaleStatus>,
}
...
pub enum PatchNamespacedDeploymentScaleResponse {
    Ok(crate::v1_14::api::autoscaling::v1::Scale),
...
impl Scale {
    ...
    pub fn replace_namespaced_deployment_scale(
        name: &str,
        namespace: &str,
        body: &crate::v1_14::api::autoscaling::v1::Scale,
...
pub enum ReplaceNamespacedDeploymentScaleResponse {
    Ok(crate::v1_14::api::autoscaling::v1::Scale),
    Created(crate::v1_14::api::autoscaling::v1::Scale),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            http::StatusCode::CREATED => {
                ...
                Ok((ReplaceNamespacedReplicationControllerScaleResponse::Created(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_14::api::autoscaling::v1::ScaleSpec> = None;
                let mut value_status: Option<crate::v1_14::api::autoscaling::v1::ScaleStatus> = None;
