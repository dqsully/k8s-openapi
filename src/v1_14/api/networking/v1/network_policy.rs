...
pub struct NetworkPolicy {
    ...
    pub spec: Option<crate::v1_14::api::networking::v1::NetworkPolicySpec>,
}
...
impl NetworkPolicy {
    ...
    pub fn create_namespaced_network_policy(
        namespace: &str,
        body: &crate::v1_14::api::networking::v1::NetworkPolicy,
...
pub enum CreateNamespacedNetworkPolicyResponse {
    Ok(crate::v1_14::api::networking::v1::NetworkPolicy),
    Created(crate::v1_14::api::networking::v1::NetworkPolicy),
    Accepted(crate::v1_14::api::networking::v1::NetworkPolicy),
...
pub enum DeleteCollectionNamespacedNetworkPolicyResponse {
    ...
    OkValue(crate::v1_14::api::networking::v1::NetworkPolicyList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedNetworkPolicyResponse {
    OkStatus(crate::v1_14::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_14::api::networking::v1::NetworkPolicy),
...
pub enum ListNamespacedNetworkPolicyResponse {
    Ok(crate::v1_14::api::networking::v1::NetworkPolicyList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_14::api::networking::v1::NetworkPolicySpec> = None;
