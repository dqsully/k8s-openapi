...
pub struct CronJob {
    ...
    pub spec: Option<crate::v1_14::api::batch::v2alpha1::CronJobSpec>,

    /// Current status of a cron job. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    pub status: Option<crate::v1_14::api::batch::v2alpha1::CronJobStatus>,
}
...
impl CronJob {
    ...
    pub fn create_namespaced_cron_job(
        namespace: &str,
        body: &crate::v1_14::api::batch::v2alpha1::CronJob,
...
pub enum CreateNamespacedCronJobResponse {
    Ok(crate::v1_14::api::batch::v2alpha1::CronJob),
    Created(crate::v1_14::api::batch::v2alpha1::CronJob),
    Accepted(crate::v1_14::api::batch::v2alpha1::CronJob),
...
pub enum DeleteCollectionNamespacedCronJobResponse {
    ...
    OkValue(crate::v1_14::api::batch::v2alpha1::CronJobList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedCronJobResponse {
    OkStatus(crate::v1_14::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_14::api::batch::v2alpha1::CronJob),
...
pub enum ListCronJobForAllNamespacesResponse {
    Ok(crate::v1_14::api::batch::v2alpha1::CronJobList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_14::api::batch::v2alpha1::CronJobSpec> = None;
                let mut value_status: Option<crate::v1_14::api::batch::v2alpha1::CronJobStatus> = None;
