...
impl Secret {
    ...
    pub fn create_namespaced_secret(
        namespace: &str,
        body: &crate::v1_14::api::core::v1::Secret,
...
pub enum CreateNamespacedSecretResponse {
    Ok(crate::v1_14::api::core::v1::Secret),
    Created(crate::v1_14::api::core::v1::Secret),
    Accepted(crate::v1_14::api::core::v1::Secret),
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            _ => {
                ...
                Ok((CreateNamespacedSecretResponse::Other(result), read))
            },
        }
    }
}
...
pub enum DeleteCollectionNamespacedSecretResponse {
    ...
    OkValue(crate::v1_14::api::core::v1::SecretList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            _ => {
                ...
                Ok((DeleteCollectionNamespacedSecretResponse::Other(result), read))
            },
        }
    }
}
...
pub enum DeleteNamespacedSecretResponse {
    OkStatus(crate::v1_14::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_14::api::core::v1::Secret),
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            http::StatusCode::ACCEPTED => {
                ...
                Ok((DeleteNamespacedSecretResponse::Accepted(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((DeleteNamespacedSecretResponse::Other(result), read))
            },
        }
    }
}
...
pub enum ListNamespacedSecretResponse {
    Ok(crate::v1_14::api::core::v1::SecretList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            _ => {
                ...
                Ok((ListNamespacedSecretResponse::Other(result), read))
            },
        }
    }
}
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            _ => {
                ...
                Ok((ListSecretForAllNamespacesResponse::Other(result), read))
            },
        }
    }
}
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            _ => {
                ...
                Ok((PatchNamespacedSecretResponse::Other(result), read))
            },
        }
    }
}
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            _ => {
                ...
                Ok((ReplaceNamespacedSecretResponse::Other(result), read))
            },
        }
    }
}
...
pub enum WatchNamespacedSecretResponse {
    Ok(crate::v1_14::apimachinery::pkg::apis::meta::v1::WatchEvent<Secret>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            ...
            _ => {
                ...
                Ok((WatchNamespacedSecretResponse::Other(result), read))
            },
        }
    }
}
...
impl Secret {
    ...
    /// This operation only supports watching one item, or a list of items, of this type for changes.
    ///
    /// Use the returned [`crate::ResponseBody`]`<`[`WatchSecretForAllNamespacesResponse`]`>` constructor, or [`WatchSecretForAllNamespacesResponse`] directly, to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `optional`
    ...
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                ...
                Ok((WatchSecretForAllNamespacesResponse::Ok(result), byte_offset))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((WatchSecretForAllNamespacesResponse::Other(result), read))
            },
        }
    }
}
