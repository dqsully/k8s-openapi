...
pub struct Pod {
    ...
    pub spec: Option<crate::v1_14::api::core::v1::PodSpec>,

    /// Most recently observed status of the pod. This data may not be up to date. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    pub status: Option<crate::v1_14::api::core::v1::PodStatus>,
}
...
impl Pod {
    ...
    pub fn create_namespaced_pod(
        namespace: &str,
        body: &crate::v1_14::api::core::v1::Pod,
...
pub enum CreateNamespacedPodResponse {
    ...
    Created(crate::v1_14::api::core::v1::Pod),
    Accepted(crate::v1_14::api::core::v1::Pod),
...
pub enum DeleteCollectionNamespacedPodResponse {
    ...
    OkValue(crate::v1_14::api::core::v1::PodList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedPodResponse {
    OkStatus(crate::v1_14::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_14::api::core::v1::Pod),
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_14::api::core::v1::PodSpec> = None;
                let mut value_status: Option<crate::v1_14::api::core::v1::PodStatus> = None;
