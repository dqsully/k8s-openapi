...
pub struct ServiceAccount {
    ...
    pub secrets: Option<Vec<crate::v1_14::api::core::v1::ObjectReference>>,
}
...
impl ServiceAccount {
    ...
    pub fn create_namespaced_service_account(
        namespace: &str,
        body: &crate::v1_14::api::core::v1::ServiceAccount,
...
pub enum CreateNamespacedServiceAccountResponse {
    Ok(crate::v1_14::api::core::v1::ServiceAccount),
    Created(crate::v1_14::api::core::v1::ServiceAccount),
    Accepted(crate::v1_14::api::core::v1::ServiceAccount),
...
pub enum DeleteCollectionNamespacedServiceAccountResponse {
    ...
    OkValue(crate::v1_14::api::core::v1::ServiceAccountList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedServiceAccountResponse {
    OkStatus(crate::v1_14::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_14::api::core::v1::ServiceAccount),
...
pub enum ListNamespacedServiceAccountResponse {
    Ok(crate::v1_14::api::core::v1::ServiceAccountList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
impl ServiceAccount {
    ...
    pub fn list_service_account_for_all_namespaces(
        ...
        let __url = "/api/v1/serviceaccounts?";
        let __request = crate::__build_request2(
            crate::http::Method::GET,
            __url.to_owned(),
            |__query_pairs| optional.__serialize(__query_pairs),
...
pub enum WatchNamespacedServiceAccountResponse {
    Ok(crate::v1_14::apimachinery::pkg::apis::meta::v1::WatchEvent<ServiceAccount>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_secrets: Option<Vec<crate::v1_14::api::core::v1::ObjectReference>> = None;
