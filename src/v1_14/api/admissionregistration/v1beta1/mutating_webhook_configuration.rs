...
impl MutatingWebhookConfiguration {
    ...
    pub fn create_mutating_webhook_configuration(
        body: &crate::v1_14::api::admissionregistration::v1beta1::MutatingWebhookConfiguration,
...
pub enum DeleteCollectionMutatingWebhookConfigurationResponse {
    ...
    OkValue(crate::v1_14::api::admissionregistration::v1beta1::MutatingWebhookConfigurationList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
